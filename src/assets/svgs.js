...
<path d="m12 2v4m0,12v4 m-10-10h4m12 0h4m-4 6 l2 2m-16 0l2-2 m0-12l-2-2m16 0l-2 2" class="cls1"/>
	...
	highlightDuplicates: `${svg24}
  <style>.cls1{fill:#000;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1px}</style>
	<rect style="fill:var(--svg-color2, yellow);stroke:none;" x="2" y="5" width="20" height="14"></rect>
	<text class="cls1" x="4" y="17" style="font-family:Arial,Helvetica,Sans-Serif;font-size:14;">×2</text>
</svg>`,
